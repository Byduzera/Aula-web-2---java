	...
	<div class="container ">
		<div class="center col-lg-6 col-sm-12">
			...
			<form action="activityRegister" method="post" id="form1">
				...
				<div class="mb-2">
					<label for="type">Tipo*</label> <select class="form-select"
				...
				<div class="mb-2">
					<label for="date">Data*</label> <input type="date" name="date"
						id="date" class="form-control" required="required">
				</div>

				<div class="mb-2">
					<label for="distance">Distância (Km)*</label> <input type="number"
						name="distance" id="distance" class="form-control" step="0.1"
						required="required">
				</div>

				<div class="mb-2">
					<label for="duration">Duração (minutos)*</label> <input
						type="number" step="1" name="duration" id="duration"
